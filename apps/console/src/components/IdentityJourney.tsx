...
export function IdentityJourney() {
  ...
  return (
    <div className="space-y-2">
      ...
      {/* ── Step 3: Connect CKB Wallet ── */}
      <Card className={!didKeyDone ? 'opacity-50 pointer-events-none' : ''}>
        <CardContent className="pt-5 pb-5">
      ...
      {/* ── Step 4: Choose PDS & Username ── */}
      <Card className={!walletDone ? 'opacity-50 pointer-events-none' : ''}>
        <CardContent className="pt-5 pb-5">
      ...
      {/* ── Step 5: Create DID on CKB ── */}
      <Card className={!pdsConfigDone ? 'opacity-50 pointer-events-none' : ''}>
        <CardContent className="pt-5 pb-5">
      ...
      <Card className={!didCreated ? 'opacity-50 pointer-events-none' : ''}>
        <CardContent className="pt-5 pb-5">
      ...
      {/* ── Step 7: Sign In ── */}
      <Card className={!pdsRegistered ? 'opacity-50 pointer-events-none' : ''}>
        <CardContent className="pt-5 pb-5">
      ...
      {/* ── Step 8: Profile ── */}
      <Card className={!loggedIn ? 'opacity-50 pointer-events-none' : ''}>
        <CardContent className="pt-5 pb-5">
